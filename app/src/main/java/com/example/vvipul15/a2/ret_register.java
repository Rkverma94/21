...
public class ret_register extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        myFirebase = new Firebase("https://hotel-15.firebaseio.com/ecommerce/retailer"  );
        ...
        regbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myFirebase = new Firebase("https://hotel-15.firebaseio.com/ecommerce/retailer/" + name  );
                ...
                //     myNewChild.setValue(email);
                    Toast.makeText(ret_register.this, "Data Saved", Toast.LENGTH_SHORT).show();
                registerr();
            }
