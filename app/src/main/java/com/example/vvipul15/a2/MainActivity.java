    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //viewPager = (ViewPager) findViewById(R.id.viewPager);
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>
                (MainActivity.this,android.R.layout.simple_list_item_1,getResources().getStringArray(R.array.LOGIN));
        ...
        ArrayAdapter<String> myAdapter1 = new ArrayAdapter<String>
                (MainActivity.this,android.R.layout.simple_list_item_1,getResources().getStringArray(R.array.REGISTER));
